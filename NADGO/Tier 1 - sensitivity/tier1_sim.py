...
def main():
    ...
    try:
        ...
        save_json(
            ...
            {"budget": args.budget, "kill": args.kill, "source": thr_source, "qref_checksum": qref_hash,
             "policy": policy_label, "kill_strikes": args.kill_strikes, "warn_cooldown": args.warn_cooldown,
             "monitor_beta": args.monitor_beta,
